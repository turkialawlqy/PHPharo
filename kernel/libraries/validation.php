...
if(!function_exists('is_alpha')):
    ...
    {
        return (bool) (preg_match('#^[\p{L}a-zA-Z_-\s]+$#iu', $str) || ctype_alpha($str));
    }
...
if(!function_exists('is_alnum')):
    ...
    {
        return (bool) (preg_match('#^[\p{L}a-zA-Z-0-9-_]+$#ui', $str) || ctype_alnum($str));
    }
...
if(!function_exists('filter_alpha')):
    ...
    {
            preg_match_all('#[\p{L}a-z-_\s]+#iu', $str, $m);
            return implode(' ', $m[0]);
    }
...
if(!function_exists('filter_alnum')):
    ...
    {
        preg_match_all('#[\p{L}a-z0-9-_\s]+#iu', $str, $m);
        return implode(' ', $m[0]);
    }
